...
class UExecCalc_Damage : UGameplayEffectExecutionCalculation
{
	...
	void Execute(FGameplayEffectCustomExecutionParameters ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
	{
		...
		if (!bIsHit) {
			SetDamage(OutExecutionOutput, 0);
			return;
		}
		...
		SetDamage(OutExecutionOutput, Damage);
	}
	...
	void SetDamage(FGameplayEffectCustomExecutionOutput& OutExecutionOutput, float32 Damage) const
	{
		...
		EvaluatedData.SetMagnitude(Damage);
